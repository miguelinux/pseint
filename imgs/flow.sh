...
inkscape flow.svg --export-id=id_shapes_ns --export-png=../bin/imgs/flow/24/shapes_ns.png -h 1024
inkscape flow.svg --export-id=id_shapes_ns --export-png=../bin/imgs/flow/32/shapes_ns.png -h 1024
inkscape flow.svg --export-id=id_shapes_alt --export-png=../bin/imgs/flow/24/shapes_alt.png -h 1024
inkscape flow.svg --export-id=id_shapes_alt --export-png=../bin/imgs/flow/32/shapes_alt.png -h 1024
