...
private:
	...
	std::set<wxString> config; ///< palabras claves de config.txt, indican opciones de configuracion de como probar y mostrar los resultados
...
public:
	bool Load(const wxString &fname); ///< carga todos los datos del ejercicio a partir del archivo que recibe como argumento
